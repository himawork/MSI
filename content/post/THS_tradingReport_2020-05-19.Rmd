---
title: THS_tradingReport
author: Himawork
date: '2020-05-19'
slug: THS_tradingReport_2020-05-19
categories:
  - HTML
tags:
  - Reports
...
### Stock trading footsteps of 603378

```{r, echo=TRUE}
bandTest = bandCrotest('603378', K_type = 'dailyK')
bandProfit('603378', bandRes = bandTest, plot = T)
StoQplot('603378', plot = c('StoIO'))
StoQplot('603378', plot = c('StoVP'))
```

### Stock trading footsteps of 300516

```{r, echo=TRUE}
bandTest = bandCrotest('300516', K_type = 'dailyK')
bandProfit('300516', bandRes = bandTest, plot = T)
StoQplot('300516', plot = c('StoIO'))
StoQplot('300516', plot = c('StoVP'))
```

### Stock trading footsteps of 300427

```{r, echo=TRUE}
bandTest = bandCrotest('300427', K_type = 'dailyK')
bandProfit('300427', bandRes = bandTest, plot = T)
StoQplot('300427', plot = c('StoIO'))
StoQplot('300427', plot = c('StoVP'))
```

Note: reports updated on 2020-05-19