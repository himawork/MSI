...
###### *Just report front 10 stocks, un-reported were: 603035, 300808, 300001, 002864, 600557, 300101, 002837, 300177, 600129, 600200, 002973, 601698, 002126, 300513, 300439, 002331, 002760, 002338, 600895, 300429, 300755, 002127, 603266, 603566, 000835, 300432, 601200, 300109, 002151, 002697, 300034, 300507, 002661, 601689, 002082, 600546, 600198, 300631, 002079, 603790, 603533, 600556, 300455, 002655, 300288, 300250, 600862, 603949, 002813, 300206, 000733, 600826, 600818, 002216, 002529, 002635, 603056, 300719, 603477*

### Quick go to special Stock:
#### [600167](#600167); [002351](#002351); [600131](#600131); [600406](#600406); [603595](#603595); [002343](#002343); [300629](#300629); [603138](#603138); [603721](#603721); [603811](#603811)

<a name = '600167'></a>

## [Stock trading footsteps of 600167](http://stockpage.10jqka.com.cn/600167)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','600167'))
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('600167', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('600167', bandRes = bandTest, Proless = 300)
...
cat('K-plot with bandMark and trade lins of stock 600167')
SpyKplot('600167', bandRes = bandTest, viewNum = 90)
StoQplot('600167', plot = c('StoIO'), viewNum = 90)
StoQplot('600167', plot = c('StoVP'), viewNum = 90)
tradePlot('600167')
```
</p>
                    </details>
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','002351'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
if (length(ProRes[['BS.datT']]) > 1) {
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 002351')
SpyKplot('002351', bandRes = bandTest, viewNum = 90)
StoQplot('002351', plot = c('StoIO'), viewNum = 90)
StoQplot('002351', plot = c('StoVP'), viewNum = 90)
tradePlot('002351')
```
</p>
                    </details>
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','600131'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
if (length(ProRes[['BS.datT']]) > 1) {
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 600131')
SpyKplot('600131', bandRes = bandTest, viewNum = 90)
StoQplot('600131', plot = c('StoIO'), viewNum = 90)
StoQplot('600131', plot = c('StoVP'), viewNum = 90)
tradePlot('600131')
```
</p>
                    </details>
...
## [Stock trading footsteps of 600406](http://stockpage.10jqka.com.cn/600406)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','600406'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('600406', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('600406', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 600406')
SpyKplot('600406', bandRes = bandTest, viewNum = 90)
StoQplot('600406', plot = c('StoIO'), viewNum = 90)
StoQplot('600406', plot = c('StoVP'), viewNum = 90)
tradePlot('600406')
```
</p>
                    </details>
...
## [Stock trading footsteps of 603595](http://stockpage.10jqka.com.cn/603595)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','603595'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603595', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603595', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 603595')
SpyKplot('603595', bandRes = bandTest, viewNum = 90)
StoQplot('603595', plot = c('StoIO'), viewNum = 90)
StoQplot('603595', plot = c('StoVP'), viewNum = 90)
tradePlot('603595')
```
</p>
                    </details>
...
## [Stock trading footsteps of 002343](http://stockpage.10jqka.com.cn/002343)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','002343'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('002343', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('002343', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 002343')
SpyKplot('002343', bandRes = bandTest, viewNum = 90)
StoQplot('002343', plot = c('StoIO'), viewNum = 90)
StoQplot('002343', plot = c('StoVP'), viewNum = 90)
tradePlot('002343')
```
</p>
                    </details>
...
## [Stock trading footsteps of 300629](http://stockpage.10jqka.com.cn/300629)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','300629'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('300629', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('300629', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 300629')
SpyKplot('300629', bandRes = bandTest, viewNum = 90)
StoQplot('300629', plot = c('StoIO'), viewNum = 90)
StoQplot('300629', plot = c('StoVP'), viewNum = 90)
tradePlot('300629')
```
</p>
                    </details>
...
## [Stock trading footsteps of 603138](http://stockpage.10jqka.com.cn/603138)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','603138'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603138', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603138', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 603138')
SpyKplot('603138', bandRes = bandTest, viewNum = 90)
StoQplot('603138', plot = c('StoIO'), viewNum = 90)
StoQplot('603138', plot = c('StoVP'), viewNum = 90)
tradePlot('603138')
```
</p>
                    </details>
...
## [Stock trading footsteps of 603721](http://stockpage.10jqka.com.cn/603721)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','603721'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603721', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603721', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 603721')
SpyKplot('603721', bandRes = bandTest, viewNum = 90)
StoQplot('603721', plot = c('StoIO'), viewNum = 90)
StoQplot('603721', plot = c('StoVP'), viewNum = 90)
tradePlot('603721')
```
</p>
                    </details>
...
## [Stock trading footsteps of 603811](http://stockpage.10jqka.com.cn/603811)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','603811'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
```
...
```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603811', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603811', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
cat('K-plot with bandMark and trade lins of stock 603811')
SpyKplot('603811', bandRes = bandTest, viewNum = 90)
StoQplot('603811', plot = c('StoIO'), viewNum = 90)
StoQplot('603811', plot = c('StoVP'), viewNum = 90)
tradePlot('603811')
```
</p>
                    </details>
