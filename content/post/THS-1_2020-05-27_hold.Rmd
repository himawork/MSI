...
## Stock trading footsteps of 603859

```{r, echo=TRUE}
bandTest = bandCrotest('603859', bandFrom = 30, bandNum = 4)
bandProfit('603859', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('603859', plot = c('StoIO'), viewNum = 60)
StoQplot('603859', plot = c('StoVP'), viewNum = 60)
tradePlot('603859')
```

## Stock trading footsteps of 300302

```{r, echo=TRUE}
bandTest = bandCrotest('300302', bandFrom = 30, bandNum = 4)
bandProfit('300302', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300302', plot = c('StoIO'), viewNum = 60)
StoQplot('300302', plot = c('StoVP'), viewNum = 60)
tradePlot('300302')
```

## Stock trading footsteps of 603660

```{r, echo=TRUE}
bandTest = bandCrotest('603660', bandFrom = 30, bandNum = 4)
bandProfit('603660', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('603660', plot = c('StoIO'), viewNum = 60)
StoQplot('603660', plot = c('StoVP'), viewNum = 60)
tradePlot('603660')
```

## Stock trading footsteps of 300177

```{r, echo=TRUE}
bandTest = bandCrotest('300177', bandFrom = 30, bandNum = 4)
bandProfit('300177', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300177', plot = c('StoIO'), viewNum = 60)
StoQplot('300177', plot = c('StoVP'), viewNum = 60)
tradePlot('300177')
```

## Stock trading footsteps of 300513

```{r, echo=TRUE}
bandTest = bandCrotest('300513', bandFrom = 30, bandNum = 4)
bandProfit('300513', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300513', plot = c('StoIO'), viewNum = 60)
StoQplot('300513', plot = c('StoVP'), viewNum = 60)
tradePlot('300513')
```

## Stock trading footsteps of 300001

```{r, echo=TRUE}
bandTest = bandCrotest('300001', bandFrom = 30, bandNum = 4)
bandProfit('300001', bandRes = bandTest, plot = T, viewNum = 60)
