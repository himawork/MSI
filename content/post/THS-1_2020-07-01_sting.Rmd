...
###### *Just report front 10 stocks, un-reported were: 600557, 600129, 600862, 002760, 300206, 600895, 300755, 603566, 600818, 603790, 002216, 600986, 600406, 603178, 300455, 601689, 002864, 300101, 600200, 002973, 300439, 603949, 603519, 603477, 002351, 300707, 300507, 300629, 002635, 603035, 601698, 600171, 300721, 000066, 002338, 000733, 300429, 603266, 002655, 300288, 300250, 002151, 300177, 002813, 002331, 300631, 002079, 600826, 002127, 002411, 300109, 300719*

### Quick go to special Stock:
#### [600167](#600167); [000835](#000835); [600131](#600131); [603533](#603533); [300432](#300432); [600556](#600556); [603721](#603721); [002661](#002661); [300808](#300808); [300001](#300001)
...
## [Stock trading footsteps of 000835](http://stockpage.10jqka.com.cn/000835)   [[_Top_]](#)
<details>
                    <summary><mark><font color=darkred>Show details:</font></mark></summary>
                    <p>

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('000835', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('000835', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','000835'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
cat('K-plot with bandMark and trade lins of stock 000835')
SpyKplot('000835', bandRes = bandTest, viewNum = 60)
StoQplot('000835', plot = c('StoIO'), viewNum = 60)
StoQplot('000835', plot = c('StoVP'), viewNum = 60)
tradePlot('000835')
```
</p>
                    </details>
...
## [Stock trading footsteps of 603533](http://stockpage.10jqka.com.cn/603533)   [[_Top_]](#)
<details>
                    <summary><mark><font color=darkred>Show details:</font></mark></summary>
                    <p>

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603533', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603533', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','603533'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
cat('K-plot with bandMark and trade lins of stock 603533')
SpyKplot('603533', bandRes = bandTest, viewNum = 60)
StoQplot('603533', plot = c('StoIO'), viewNum = 60)
StoQplot('603533', plot = c('StoVP'), viewNum = 60)
tradePlot('603533')
```
</p>
                    </details>
...
## [Stock trading footsteps of 300432](http://stockpage.10jqka.com.cn/300432)   [[_Top_]](#)
<details>
                    <summary><mark><font color=darkred>Show details:</font></mark></summary>
                    <p>

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('300432', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('300432', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','300432'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
cat('K-plot with bandMark and trade lins of stock 300432')
SpyKplot('300432', bandRes = bandTest, viewNum = 60)
StoQplot('300432', plot = c('StoIO'), viewNum = 60)
StoQplot('300432', plot = c('StoVP'), viewNum = 60)
tradePlot('300432')
```
</p>
                    </details>
...
## [Stock trading footsteps of 600556](http://stockpage.10jqka.com.cn/600556)   [[_Top_]](#)
<details>
                    <summary><mark><font color=darkred>Show details:</font></mark></summary>
                    <p>

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('600556', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('600556', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','600556'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
cat('K-plot with bandMark and trade lins of stock 600556')
SpyKplot('600556', bandRes = bandTest, viewNum = 60)
StoQplot('600556', plot = c('StoIO'), viewNum = 60)
StoQplot('600556', plot = c('StoVP'), viewNum = 60)
tradePlot('600556')
```
</p>
                    </details>
...
## [Stock trading footsteps of 002661](http://stockpage.10jqka.com.cn/002661)   [[_Top_]](#)
<details>
                    <summary><mark><font color=darkred>Show details:</font></mark></summary>
                    <p>

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('002661', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('002661', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','002661'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
cat('K-plot with bandMark and trade lins of stock 002661')
SpyKplot('002661', bandRes = bandTest, viewNum = 60)
StoQplot('002661', plot = c('StoIO'), viewNum = 60)
StoQplot('002661', plot = c('StoVP'), viewNum = 60)
tradePlot('002661')
```
</p>
                    </details>
...
## [Stock trading footsteps of 300808](http://stockpage.10jqka.com.cn/300808)   [[_Top_]](#)
<details>
                    <summary><mark><font color=darkred>Show details:</font></mark></summary>
                    <p>

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('300808', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('300808', bandRes = bandTest, Proless = 300)
if (length(ProRes[['BS.datT']]) > 1) {
                      rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                      rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                      aggregatorName = 'Integer Sum', vals = 'profit', subtotals = T,
                      ...
                      rendererName = 'Table With Subtotal Bar Chart', 
                      rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))}
raw.sto <- read_html(paste0('http://stockpage.10jqka.com.cn/','300808'))
html_node(raw.sto,'strong') %>% html_text() %>% cat()
html_nodes(raw.sto, 'div.analyze-txt-cont') %>% html_text() %>% 
                    gsub('[\n\t]','',.) %>% print()
cat('K-plot with bandMark and trade lins of stock 300808')
SpyKplot('300808', bandRes = bandTest, viewNum = 60)
StoQplot('300808', plot = c('StoIO'), viewNum = 60)
StoQplot('300808', plot = c('StoVP'), viewNum = 60)
tradePlot('300808')
```
</p>
                    </details>
