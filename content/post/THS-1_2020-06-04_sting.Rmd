...
###### *Just report front 10 stocks, un-reported were: 300658, 600984, 000733, 600167, 300418, 002343, 002771, 002635, 002648, 300439, 600171, 002813, 000066, 000037, 002760, 002436, 000823, 600521, 300125, 603566, 603477, 000980, 002529, 000835, 600131, 300707, 603660, 600556, 300132, 603721, 300808, 002373, 002261, 300001, 002864, 603733, 300119, 600129, 300363, 002402, 600391, 600198, 603519, 603266, 603017, 603790, 603256, 600021, 603138, 002111, 000987, 300719, 300501*
...
## [Stock trading footsteps of 300250](http://stockpage.10jqka.com.cn/300250)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('300250', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('300250', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('300250', bandRes = bandTest, viewNum = 60)
StoQplot('300250', plot = c('StoIO'), viewNum = 60)
StoQplot('300250', plot = c('StoVP'), viewNum = 60)
tradePlot('300250')
```
...
## [Stock trading footsteps of 603336](http://stockpage.10jqka.com.cn/603336)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603336', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603336', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('603336', bandRes = bandTest, viewNum = 60)
StoQplot('603336', plot = c('StoIO'), viewNum = 60)
StoQplot('603336', plot = c('StoVP'), viewNum = 60)
tradePlot('603336')
```

## [Stock trading footsteps of 600685](http://stockpage.10jqka.com.cn/600685)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('600685', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('600685', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('600685', bandRes = bandTest, viewNum = 60)
StoQplot('600685', plot = c('StoIO'), viewNum = 60)
StoQplot('600685', plot = c('StoVP'), viewNum = 60)
tradePlot('600685')
```

## [Stock trading footsteps of 603949](http://stockpage.10jqka.com.cn/603949)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('603949', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('603949', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('603949', bandRes = bandTest, viewNum = 60)
StoQplot('603949', plot = c('StoIO'), viewNum = 60)
StoQplot('603949', plot = c('StoVP'), viewNum = 60)
tradePlot('603949')
```

## [Stock trading footsteps of 300631](http://stockpage.10jqka.com.cn/300631)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('300631', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('300631', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('300631', bandRes = bandTest, viewNum = 60)
StoQplot('300631', plot = c('StoIO'), viewNum = 60)
StoQplot('300631', plot = c('StoVP'), viewNum = 60)
tradePlot('300631')
```
...
## [Stock trading footsteps of 000963](http://stockpage.10jqka.com.cn/000963)   [[_Top_]](#)

```{r, echo=FALSE, warning=FALSE, fig.align='center'}
bandTest = bandSword('000963', bandFrom = 30, days = 10, ratio = 0.8)
ProRes = bandProfit('000963', bandRes = bandTest, Proless = 300)
rpivotTable::rpivotTable(ProRes[['BS.datT']], 
                 rows = 'tags', cols = c('bandDate','BS.Date','FinalHold'),
                 aggregatorName = 'Sum', vals = 'profit', subtotals = T,
                 inclusions = list(bandDate = unique(ProRes[['BS.datT']]$bandDate)[1:6]),  
                 rendererName = 'Table With Subtotal Heatmap', 
                 rendererOptions = list(collapseRowsAt = 0, collapseColsAt = 0))
SpyKplot('000963', bandRes = bandTest, viewNum = 60)
StoQplot('000963', plot = c('StoIO'), viewNum = 60)
StoQplot('000963', plot = c('StoVP'), viewNum = 60)
tradePlot('000963')
```
...
Note: reports updated on 2020-06-04