...
###### *Just report front 10 stocks, un-reported were: 603992, 600986, 603363, 600556, 300455, 002343, 300288, 603721, 603035, 300422, 300250, 002373, 002648, 300101, 300109, 002151, 300177, 300513, 600699, 600513, 000987, 600171, 600198, 600685, 603949, 000037, 002760, 002697, 002436, 300429, 000823, 300274, 600521, 002952, 603790, 603115, 300418, 600131, 603037, 002655, 300629, 300132, 603336, 300203, 300439, 600546, 603519, 000066, 002887, 300206, 000733, 603017, 603477*

## Stock trading footsteps of 603533

```{r, echo=TRUE}
bandTest = bandCrotest('603533', bandFrom = 30, bandNum = 4)
bandProfit('603533', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('603533', plot = c('StoIO'), viewNum = 60)
StoQplot('603533', plot = c('StoVP'), viewNum = 60)
tradePlot('603533')
```

## Stock trading footsteps of 300707
...
## Stock trading footsteps of 002661

```{r, echo=TRUE}
bandTest = bandCrotest('002661', bandFrom = 30, bandNum = 4)
bandProfit('002661', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('002661', plot = c('StoIO'), viewNum = 60)
StoQplot('002661', plot = c('StoVP'), viewNum = 60)
tradePlot('002661')
```

## Stock trading footsteps of 300053

```{r, echo=TRUE}
bandTest = bandCrotest('300053', bandFrom = 30, bandNum = 4)
bandProfit('300053', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300053', plot = c('StoIO'), viewNum = 60)
StoQplot('300053', plot = c('StoVP'), viewNum = 60)
tradePlot('300053')
```

## Stock trading footsteps of 300664

```{r, echo=TRUE}
bandTest = bandCrotest('300664', bandFrom = 30, bandNum = 4)
bandProfit('300664', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300664', plot = c('StoIO'), viewNum = 60)
StoQplot('300664', plot = c('StoVP'), viewNum = 60)
tradePlot('300664')
```

## Stock trading footsteps of 600511

```{r, echo=TRUE}
bandTest = bandCrotest('600511', bandFrom = 30, bandNum = 4)
bandProfit('600511', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('600511', plot = c('StoIO'), viewNum = 60)
StoQplot('600511', plot = c('StoVP'), viewNum = 60)
tradePlot('600511')
```

## Stock trading footsteps of 300363

```{r, echo=TRUE}
bandTest = bandCrotest('300363', bandFrom = 30, bandNum = 4)
bandProfit('300363', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300363', plot = c('StoIO'), viewNum = 60)
StoQplot('300363', plot = c('StoVP'), viewNum = 60)
tradePlot('300363')
```

## Stock trading footsteps of 002331

```{r, echo=TRUE}
bandTest = bandCrotest('002331', bandFrom = 30, bandNum = 4)
bandProfit('002331', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('002331', plot = c('StoIO'), viewNum = 60)
StoQplot('002331', plot = c('StoVP'), viewNum = 60)
tradePlot('002331')
```

## Stock trading footsteps of 300501

```{r, echo=TRUE}
bandTest = bandCrotest('300501', bandFrom = 30, bandNum = 4)
bandProfit('300501', bandRes = bandTest, plot = T, viewNum = 60)
StoQplot('300501', plot = c('StoIO'), viewNum = 60)
StoQplot('300501', plot = c('StoVP'), viewNum = 60)
tradePlot('300501')
```

## Stock trading footsteps of 603256
