...
SpyKplot = function(Scode = '', type = c('sting'), bandRes = bandTest, Protest = ProRes[['Buydat']], 
  ...
  if (Scode %in% BuyScodeNum) {
    ...
    if (Symbol == 'A' & max.pos < 5) {
      AVsym = "A-"
    } else if (Symbol == 'V' & min.pos < 5) {
      AVsym = "V-"
    } else if (Symbol == 'A' & max.pos > 5) {
      AVsym = "A+"
    } else if (Symbol == 'V' & min.pos > 5) {
      AVsym = "V+"
    } else NULL
    print(paste0('AVsym prediction in ten days was ',AVsym))
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '300177')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '603266')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '300658')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '601689')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '603686')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '603363')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '002577')] + 5
...
viewNum = Anahis.res[['sto.dat']]$minView[which(Anahis.res[['sto.dat']]$Scode == '300592')] + 5
...
Note: reports updated on 2020-06-30