...
SpyKplot = function(Scode = '', type = c('sting'), bandRes = bandTest, Protest = ProRes[['Buydat']], 
  ...
  if (Scode %in% BuyScodeNum) {
    ...
    # echo AV prediction
    if (TRUE) {
      min.pos = which.min(dataK$LOW[1:10]); max.pos = which.max(dataK$HIGH[1:10])
      Symbol = ifelse(max.pos < min.pos, 'A', 'V')
      RVib = ifelse(Symbol == "A", ((dataK$LOW[1] - dataK$HIGH[max.pos]) / dataK$HIGH[max.pos] * 100),
                    ((dataK$HIGH[1] - dataK$LOW[min.pos]) / dataK$LOW[min.pos] * 100))
      ...
      if (Symbol == 'A' & max.pos <= 5) { AVsym = "A-"
      } else if (Symbol == 'V' & min.pos < 5) { AVsym = "V+"
      } else if (Symbol == 'A' & max.pos > 5) { AVsym = "A+"
      } else if (Symbol == 'V' & min.pos >= 5) { AVsym = "V-"
      }
      if (!Randtheme) {
      ...
      if (Randtheme) {
        Hvalue0 = dataK$LOW[10] * 0.97;  Hvalue0.pos = dataK$Date[10]
        ...
        Hvalue3 = dataK$LOW[1] * 0.97; Hvalue3.pos = dataK$Date[1]
        value1 = round(LVib, 2); value2 = round(RVib, 2); 
        value0 = round((dataK$CLOSE[Start.pos] - dataK$CLOSE[10]) / dataK$CLOSE[10] * 100, 2)
...
SpyKplot('300177', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('300177', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('300177', plot = c('StoIO'), viewNum = 60)
StoQplot('300177', plot = c('StoVP'), viewNum = 60)
tradePlot('300177')
```
</p>
                    </details>
...
SpyKplot('603266', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('603266', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('603266', plot = c('StoIO'), viewNum = 60)
StoQplot('603266', plot = c('StoVP'), viewNum = 60)
tradePlot('603266')
```
</p>
                    </details>
...
SpyKplot('300658', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('300658', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('300658', plot = c('StoIO'), viewNum = 60)
StoQplot('300658', plot = c('StoVP'), viewNum = 60)
tradePlot('300658')
```
</p>
                    </details>
...
SpyKplot('601689', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('601689', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('601689', plot = c('StoIO'), viewNum = 60)
StoQplot('601689', plot = c('StoVP'), viewNum = 60)
tradePlot('601689')
```
</p>
                    </details>
...
SpyKplot('603686', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('603686', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('603686', plot = c('StoIO'), viewNum = 60)
StoQplot('603686', plot = c('StoVP'), viewNum = 60)
tradePlot('603686')
```
</p>
                    </details>
...
SpyKplot('603363', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('603363', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('603363', plot = c('StoIO'), viewNum = 60)
StoQplot('603363', plot = c('StoVP'), viewNum = 60)
tradePlot('603363')
```
</p>
                    </details>
...
SpyKplot('002577', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('002577', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('002577', plot = c('StoIO'), viewNum = 60)
StoQplot('002577', plot = c('StoVP'), viewNum = 60)
tradePlot('002577')
```
</p>
                    </details>
...
SpyKplot('300592', bandRes = bandTest, viewNum = 60)
cat('K-line hostory plot of holden stock.')
...
SpyKplot('300592', bandRes = Anahis.sto[c(1,3), c('xAxis1', 'value', 'name1', 'yAxis1')],
                             Protest = Anahis.sto, viewNum = viewNum, Randtheme = T)
StoQplot('300592', plot = c('StoIO'), viewNum = 60)
StoQplot('300592', plot = c('StoVP'), viewNum = 60)
tradePlot('300592')
```
</p>
                    </details>

Note: reports updated on 2020-07-03